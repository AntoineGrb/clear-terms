...
const PRICING_PLANS = {
  standard: {
    ...
    amount: 2,
    scans: 20,
    priceId: 'prod_TInIFx7sfK2Olz' // À remplacer par votre vrai Price ID
  },
  comfort: {
    name: 'Pack Confort',
    amount: 5,
    scans: 100,
    priceId: 'prod_TInILz7xwO1M3R' // À remplacer par votre vrai Price ID
  },
  pro: {
    name: 'Pack Pro',
    amount: 20,
    scans: 1000,
    priceId: 'prod_TInJHmzR1lpo06' // À remplacer par votre vrai Price ID
  }
};
